...
!function($){
  ...
  $.fn.onepage_scroll = function(options){
    ...
    $.each( sections, function(i) {
      ...
      topPos = topPos + 100;
      if(settings.pagination == true) {
        paginationList = "<li><a data-index='"+(i+1)+"' href='#" + (i+1) + "'>" + menu[i] + "</a></li>" + paginationList;
      }
    });
    ...
    if(settings.pagination == true) {
      $("<ul class='back onepage-pagination'>" + paginationList + "</ul>").prependTo("body");
